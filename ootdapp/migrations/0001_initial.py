    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_name', models.CharField(max_length=10, verbose_name='시군구명')),
                ...
                ('city_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ootdapp.city')),
                ('sido_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ootdapp.sido')),
            ],
        ),
        migrations.AddField(
            model_name='city',
